...
#SBATCH --job-name=voc12_train_slim
#SBATCH --mail-user=nhlben@connect.hku.hk
#SBATCH --mail-type=ALL
#SBATCH --output=/userhome/cs2/nhlben/comp7404/project/voc12_train_slim.txt
#SBATCH --gres=gpu:1
...
python tools/train.py \
       --config configs/rtformer/rtformer_slim_voc12_512x512_120k.yml \
       --do_eval \
       --use_vdl \
       --save_interval 500 \
       --save_dir output