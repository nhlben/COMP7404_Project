...
#SBATCH --job-name=voc12_predict_base
#SBATCH --mail-user=nhlben@connect.hku.hk
#SBATCH --mail-type=ALL
#SBATCH --output=/userhome/cs2/nhlben/comp7404/project/voc12_base_predict_log.txt
#SBATCH --gres=gpu:1
...
python tools/val.py \
       ...
       --model_path output/voc12_base/best_model/model.pdparams \

python tools/predict.py \
       --config configs/rtformer/rtformer_base_voc12_512x512_120k.yml \
       --model_path output/voc12_base/best_model/model.pdparams \
       --image_path data/VOCdevkit/VOC2012/JPEGImages \
       --save_dir output/voc12_base/predict
